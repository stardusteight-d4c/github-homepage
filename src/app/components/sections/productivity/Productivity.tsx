  ...
  return (
    <section className="max-w-[100vw] relative text-white mt-[150px]          mb-[100px]">
      <div className="max-w-7xl mx-auto">
        <div className="ml-[115px] mb-[96px]">
          <h2 className="text-[24px] relative mb-[24px] leading-[28px] font-semibold font-roboto">
            <div className="absolute flex items-center justify-center -left-[74px] z-20 ">
              ...
              <div className="absolute rounded-xl z-0 bottom-[-380px] w-[4px] h-[360px] bg-gradient-to-b from-[#55d163] via-[#55d163] to-transparent" />
            </div>
            Productivity
          </h2>
      ...
      <div className="border z-20 relative border-[#30363d] rounded-xl overflow-hidden max-w-[1278px] w-full mx-auto">
        ...
        <div className="h-[624px] flex">
          <div className="p-[24px] h-full bg-[#161b22] border-r border-[#30363d] border-t-0 w-fit">
            ...
            <div className="w-full h-fit">
              ...
              <div className="bg-[#040D21]">
                <Image
                  ...
                  height={591}
                  quality={100}
                  className="w-[500px] h-[591px] mx-auto object-contain"
                />
              </div>
            </div>
          </div>
