    ...
    <>
      ...
      <section className="relative text-[#f0f0f0] px-[8px] md:px-[16px] xl:px-0 max-w-7xl mx-auto w-full h-fit">
        ...
        <div className="flex items-center justify-center flex-col max-w-[100vw]">
          <div className="relative z-50 pt-[100px] md:pt-[160px] w-full md:w-fit">
            <h4 className="text-[38px] md:text-[54px] text-center lg:max-w-[840px] mx-auto font-jet-brains text-[#f6f8fa] leading-[48px] md:leading-[58px] md:tracking-[-4px] font-bold">
              The place for anyone from anywhere to build anything
            </h4>
            <p className="text-[20px] text-[#7d8590] leading-[28px] md:max-w-[724px] w-full text-center mx-auto mt-[16px]">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-y-2 gap-x-2 mt-[50px]">
              ...
              <button className="trial-span span w-full md:w-fit transition-all ease-in-out duration-300 relative flex items-center justify-center py-[17px] px-[30px] rounded-md bg-transparent border-[1px] hover:border-[#f6f8fa] border-[#ffffff2e] font-semibold">
